...
import type { Organization, OrgStatus, Plan } from "@/lib/superadmin/types";
...
export function OrganizationForm({ plans, initial, submitLabel, onSubmit, onCancel }: OrganizationFormProps) {
