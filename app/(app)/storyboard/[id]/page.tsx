...
export default function StoryboardReadonlyPage() {
  ...
  const viewWrapClass = "max-w-[1100px]";
  ...
  return (
    <div className={`${viewWrapClass} mx-auto px-6 py-10 pb-28 animate-in fade-in duration-500`}>
      <div className="flex items-center justify-between mb-8 gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap justify-end">
          <button
            ...
            className="px-4 py-2 rounded-xl border border-slate-200 bg-white text-[12px] font-bold text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-colors shadow-sm"
          >
